...
image: /images/posts/linear-gradient-text/banner.webp
---
...
![Linear Gradient Effect in Next.js Site](/images/posts/linear-gradient-text/linear-gradient-in-next-js-site.webp)
...
![The Linear Gradient Effect on 1chooo.com](/images/posts/linear-gradient-text/after.webp)
...
![The Problem of Selecting Text](/images/posts/linear-gradient-text/selection-not-work.webp)
...
![Final Result of the Linear Gradient Effect on 1chooo.com](/images/posts/linear-gradient-text/final.webp)
