...
banner: /images/banner/enable-vscode-mdx-wrap.webp
---
...
![Default MDX file in VSCode without word wrap enabled](/images/posts/enable-vscode-mdx-wrap/before.webp)
...
![Type "Toggle Word Wrap" in the command palette](/images/posts/enable-vscode-mdx-wrap/toogle-word-wrap.webp)
...
![MDX file in VSCode with word wrap enabled](/images/posts/enable-vscode-mdx-wrap/after.webp)
