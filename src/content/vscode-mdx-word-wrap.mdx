...
![Default MDX file in VSCode without word wrap enabled](/images/posts/vscode-mdx-word-wrap/before.webp)
...
![Type "Toggle Word Wrap" in the command palette](/images/posts/vscode-mdx-word-wrap/toogle-word-wrap.webp)
...
![MDX file in VSCode with word wrap enabled](/images/posts/vscode-mdx-word-wrap/after.webp)
