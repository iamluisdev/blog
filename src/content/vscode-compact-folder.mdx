...
<MarkdownAlert type="info">
  Just imagine trying to deal with something like that every day. Total nightmare. (And no, we don't recommend naming folders like this — it's just for demonstration of the nightmare.)
</MarkdownAlert>
