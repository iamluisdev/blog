...
summary: "How to Add a Gradient Effect to Text for Eye-Catching Web Design"
image: /images/posts/css-gradient-text/banner.webp
---
...
![Linear Gradient Effect in Next.js Site](/images/posts/css-gradient-text/linear-gradient-in-next-js-site.webp)
...
![The Linear Gradient Effect on 1chooo.com](/images/posts/css-gradient-text/after.webp)
...
![The Problem of Selecting Text](/images/posts/css-gradient-text/selection-not-work.webp)
...
![Final Result of the Linear Gradient Effect on 1chooo.com](/images/posts/css-gradient-text/final.webp)
