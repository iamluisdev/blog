...
<MarkdownAlert type="info">
  I use [pnpm](https://pnpm.io/) as my package manager. Make sure it's installed before running the commands below. Or you can also use <Highlight variant="blue"><code>npm</code></Highlight> or <Highlight variant="blue"><code>yarn</code></Highlight> instead.
</MarkdownAlert>
...
<div class="relative group">
  <pre data-line-numbers class="shiki shiki-themes github-light github-dark" style="--shiki-light: #24292e; --shiki-dark: #e1e4e8; --shiki-light-bg: #fff; --shiki-dark-bg: #24292e;">
